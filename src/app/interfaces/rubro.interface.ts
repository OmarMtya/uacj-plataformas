...
export const Trayectorias = ['matricula', 'aspirantes', 'aprobacion', 'desercion', 'retencion', 'eficiencia_terminal', 'egresados', 'titulados'];
export const Desarrollos = ['padron_licenciatura', 'padron_posgrado', 'seguimiento2', 'seguimiento5', 'avance_padron_egreso', 'avance_seguimiento_2', 'avance_seguimiento_5'];
